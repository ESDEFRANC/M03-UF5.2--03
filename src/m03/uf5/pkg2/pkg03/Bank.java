...
public class Bank {
    ...
    public void extractSaldo(double extract) throws SaldoInsuficienteException{
        ...
        if(extract>saldo){
            double porciento =extract*100/10;
            saldo = saldo-(porciento+extract);
            System.out.println("Has gastado todo el saldo tienes en cuenta: " + saldo);
    ...
    public void ingresarSaldo(double ingress){
            this.saldo = saldo + ingress;
